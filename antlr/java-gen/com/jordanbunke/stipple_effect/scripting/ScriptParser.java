...
public class ScriptParser extends Parser {
	...
	public final Head_ruleContext head_rule() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -2017641184930823856L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 12062818319L) != 0)) {
				{
				{
				setState(47);
				stat();
	...
	public final Return_statContext return_stat() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -2305836376710446768L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 12062818319L) != 0)) {
				{
				setState(218);
				expr(0);
				}
